...
function NavBar() {
  ...
  return (
    <header data-testid="navbar"
      className={`sticky top-0 z-50 w-full transition-all duration-300 ${scrolled ? "border-b border-[#E5E7EB] bg-white/95 shadow-sm backdrop-blur-md" : "bg-white/80 backdrop-blur-sm"}`}
    >
      <div className="mx-auto flex h-[68px] max-w-[1280px] items-center justify-between px-6 xl:px-10">
        <a href="#home" className="flex items-center gap-2.5 shrink-0" data-testid="logo">
          ...
          <div>
            <span className="font-heading text-[15px] font-bold text-[#071626] block leading-tight">Nexwavy</span>
            <span className="text-[10px] font-medium tracking-wide text-[#697586] block">Solutions</span>
          </div>
        </a>
        <nav className="hidden lg:flex items-center gap-1">
          {["Home", "About", "Services", "AI Training", "Contact"].map(item => (
            <a key={item} href={`#${item.toLowerCase().replace(" ", "-")}`}
              ...
              data-testid={`nav-${item.toLowerCase().replace(/\s+/g, "-")}`}>{item}</a>
          ))}
        </nav>
        <div className="hidden lg:flex items-center gap-3">
          <a href={whatsappUrl} target="_blank" rel="noreferrer"
            ...
            data-testid="nav-whatsapp"><MessageCircle className="h-3.5 w-3.5" /> WhatsApp</a>
          <a href="mailto:hello@nexwavy.com"
            ...
            data-testid="nav-start">Book Consultation</a>
        </div>
        <button className="lg:hidden rounded-md p-2 text-[#071626]" onClick={() => setOpen(!open)} data-testid="nav-mobile-toggle">
        ...
        <div className="lg:hidden border-t border-[#E5E7EB] bg-white px-6 py-4 space-y-1.5">
          ...
          <div className="pt-3 space-y-2 border-t border-[#E5E7EB]">
            <a href={whatsappUrl} target="_blank" rel="noreferrer" className="flex w-full items-center justify-center gap-2 rounded-full border border-[#E5E7EB] py-2.5 text-sm font-semibold text-[#071626]">
              <MessageCircle className="h-4 w-4" /> Chat on WhatsApp</a>
            <a href="mailto:hello@nexwavy.com" className="flex w-full items-center justify-center rounded-full bg-[#3069B0] py-2.5 text-sm font-semibold text-white">Book Consultation</a>
          </div>
        </div>
      )}
    </header>
  ...
  return (
    <section id="home" className="relative overflow-hidden bg-white">
      ...
      <div className="pointer-events-none absolute inset-0" style={{
        backgroundImage: "linear-gradient(rgba(48,105,176,0.045) 1px,transparent 1px),linear-gradient(90deg,rgba(48,105,176,0.045) 1px,transparent 1px)",
      ...
      <div className="relative mx-auto max-w-[1280px] px-6 xl:px-10 pt-16 pb-10">
        ...
        <motion.div initial="hidden" animate="visible" className="mx-auto max-w-4xl text-center mb-10">
          <motion.div custom={0} variants={fadeUp}
            ...
            <span className="text-[11px] font-bold tracking-widest text-[#3069B0] uppercase">Now onboarding — AI Training &amp; Automation</span>
          </motion.div>
          ...
          <motion.div custom={3} variants={fadeUp} className="flex flex-wrap items-center justify-center gap-3 mb-6">
            <a href="mailto:hello@nexwavy.com"
              ...
              data-testid="hero-cta-primary">Start a Project <ArrowRight className="ml-2 h-4 w-4" /></a>
            <a href={whatsappUrl} target="_blank" rel="noreferrer"
              ...
              data-testid="hero-cta-whatsapp"><MessageCircle className="h-4 w-4" /> Chat on WhatsApp</a>
          </motion.div>
          ...
          <motion.div custom={4} variants={fadeUp} className="flex flex-wrap items-center justify-center gap-2">
            {["Business Automation", "AI Training", "IT Advisory"].map(tag => (
              <span key={tag} className="rounded-full border border-[#E5E7EB] bg-[#F4F7FB] px-4 py-1.5 text-[11px] font-bold uppercase tracking-widest text-[#697586]">{tag}</span>
            ))}
          </motion.div>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.35 }}
          className="relative w-full overflow-hidden rounded-2xl border border-[#E5E7EB] shadow-2xl shadow-[#071626]/12" style={{ height: 400 }}>
          <img
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
            <p className="text-[10px] font-bold tracking-widest text-[#1E90FF] uppercase mb-3">Illustrative Workflow</p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {[
                ...
                <div key={i} className="flex items-center gap-3 rounded-xl border border-white/15 bg-white/10 backdrop-blur-md px-4 py-3">
...
function Challenges() {
  ...
  return (
    <section id="about" className="bg-[#071626] py-20 lg:py-24 relative overflow-hidden">
      <div className="pointer-events-none absolute right-0 top-0 font-heading text-[280px] font-black text-white/[0.025] select-none leading-none translate-x-10 -translate-y-10">N</div>
      <div className="relative mx-auto max-w-[1280px] px-6 xl:px-10">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-14">
          ...
          <motion.h2 custom={1} variants={fadeUp} className="font-heading text-3xl font-bold text-white md:text-4xl lg:text-5xl mx-auto max-w-3xl leading-tight">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
          className="w-full overflow-hidden rounded-2xl border border-white/10 shadow-xl mb-10" style={{ height: 320 }}>
          <img
        ...
        {/* Body copy + problem cards */}
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="lg:col-span-4 space-y-4 text-[15px] text-[#697586] leading-relaxed">
            <motion.p custom={0} variants={fadeUp}>Many businesses still run critical operations through WhatsApp messages, Excel sheets, paper forms, scattered approvals, and repeated follow-ups.</motion.p>
            <motion.p custom={1} variants={fadeUp}>The result is predictable: delayed execution, weak reporting, avoidable errors, missed opportunities, and poor visibility for decision-makers.</motion.p>
            <motion.p custom={2} variants={fadeUp} className="font-semibold text-white/90">The companies that improve fastest are not always the biggest. They are the ones that build better systems earlier.</motion.p>
          </motion.div>

          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="lg:col-span-8 grid sm:grid-cols-2 gap-5">
  ...
  const services = [
    {
      ...
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=85&auto=format&fit=crop&crop=focalpoint",
    ...
    <section id="services" className="bg-[#F4F7FB] py-20 lg:py-24">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-10">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-12">
          ...
          <motion.h2 custom={1} variants={fadeUp} className="font-heading text-3xl font-bold text-[#071626] md:text-4xl lg:text-5xl mx-auto max-w-3xl leading-tight">
          ...
          {services.map(({ icon: Icon, title, desc, bullets, image, cta, color }, i) => (
            <motion.div key={i}
              ...
              <div className="flex flex-col flex-1 p-6">
                ...
                <a href="mailto:hello@nexwavy.com"
                  className="mt-auto inline-flex items-center text-sm font-bold transition-colors group-hover:underline"
                  style={{ color }} data-testid={`service-cta-${i}`}>
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.3 }}
          ...
          <a href="mailto:hello@nexwavy.com" className="shrink-0 inline-flex h-10 items-center rounded-full bg-[#3069B0] px-6 text-sm font-bold text-white hover:bg-[#071626] transition-colors">
            Talk to us →
          </a>
        </motion.div>
      </div>
  ...
  return (
    <section className="bg-[#071626] py-20 lg:py-24 relative overflow-hidden">
      <div className="relative mx-auto max-w-[1280px] px-6 xl:px-10">
        {/* Centred header */}
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-14">
          <motion.p custom={0} variants={fadeUp} className="mb-3 text-[10px] font-bold tracking-widest text-[#1E90FF] uppercase">The Nexwavy Method</motion.p>
          <motion.h2 custom={1} variants={fadeUp} className="font-heading text-3xl font-bold text-white md:text-4xl lg:text-5xl mx-auto max-w-2xl leading-tight">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-5">
            <motion.div initial={{ opacity: 0, x: 16 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
              className="overflow-hidden rounded-2xl border border-[#E5E7EB] shadow-lg" style={{ height: 220 }}>
              <img
            ...
            <motion.div initial={{ opacity: 0, x: 16 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.15 }}
    ...
    <section id="ai-training" className="bg-white py-20 lg:py-24">
      <div className="mx-auto max-w-[1280px] px-6 xl:px-10">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-12">
          ...
          <motion.h2 custom={1} variants={fadeUp} className="font-heading text-3xl font-bold text-[#071626] md:text-4xl lg:text-5xl mx-auto max-w-2xl leading-tight">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
          {offers.map(({ badge, title, price, desc, cta, featured }, i) => (
            <motion.div key={i}
              ...
              className={`flex flex-col rounded-2xl border p-6 hover:-translate-y-1 hover:shadow-xl transition-all ${featured ? "border-[#3069B0] bg-[#3069B0] shadow-xl shadow-[#3069B0]/30" : "border-[#E5E7EB] bg-white shadow-sm hover:shadow-[#071626]/10"}`}>
              ...
              <a href="mailto:hello@nexwavy.com"
                className={`inline-flex items-center justify-center gap-2 rounded-full py-2.5 px-5 text-sm font-bold transition-all ${featured ? "bg-white text-[#3069B0] hover:bg-[#F4F7FB]" : "border border-[#E5E7EB] text-[#071626] hover:border-[#3069B0] hover:text-[#3069B0]"}`}
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }}
            ...
            <a href="mailto:hello@nexwavy.com"
              ...
              data-testid="cta-start">Start a Project <ArrowRight className="ml-2 h-4 w-4" /></a>
            <a href={whatsappUrl} target="_blank" rel="noreferrer"
              ...
              data-testid="cta-whatsapp"><MessageCircle className="h-4 w-4" /> Chat on WhatsApp</a>
          </motion.div>
        </div>
      </div>
    </section>
      ...
      <div className="mx-auto max-w-[1280px] px-6 xl:px-10 py-16">
        <div className="grid lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-[10px] font-bold tracking-widest text-[#3069B0] uppercase mb-5">Business Automation · AI Training · IT Advisory</p>
